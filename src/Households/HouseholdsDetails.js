        ...
        if (this.props.house === undefined) {
            ...
            return <div>
                        <div id="house-details-members-list">
                            ...
                            return <MemberCircle key={value.username} member={value.username} memberSpacing='house-details-member' circleSize="36pt" nameSize="14pt"/>})}
                            There are {this.props.house.members.length} members in this household
                        </div>
